...
$sql = "SELECT sr.*, u.nome FROM solicitações_resgate sr JOIN usuarios u ON sr.usuario_id = u.id WHERE sr.status = 'Processando'";
...
<head>
    ...
    <link rel="stylesheet" href="styleindicacoes.php">
