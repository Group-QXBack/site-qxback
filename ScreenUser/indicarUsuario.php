...
<body>
    ...
    <nav class="menu-lateral">
        ...
        <ul>
            <li class="item-menu">
                <a href="../ScreenUser/index.php">
                    <span class="icon"><i class="bi bi-person-fill"></i></span>
                    <span class="txt-link">Perfil</span>
                </a>
            </li>
            <li class="item-menu">
                <a href="../ScreenUser/indicacoes.php">
        ...
        <div class="primeira_sessao">
         <div class="titulo">
            ...
            <div class="form-indicacao">
                <div action="processar_indicacao.php" method="POST">
                    <p>
                    ...
                    <div class="botoes">
                    <button onclick="addServico()" style="background-color:#8f8f8f;">Adicionar Mais Serviços</button>
