...
<body>
            ...
            <article>
                ...
                <main class="dados-perfil">
                    <div class="dados">
                        <p>
                            <strong>CPF:</strong>
                            <input type="text" class="input-text" value="<?php echo htmlspecialchars($usuario['cpf'] ?? ''); ?>" readonly>
                            <strong>Data de Nascimento:</strong>
                            <input type="date" class="input-date" value="<?php echo htmlspecialchars($usuario['data_nasc'] ?? ''); ?>" readonly>
                        </p>
                        <p>
                            <strong>Email:</strong>
                            <input type="text" class="input-text" value="<?php echo htmlspecialchars($usuario['email'] ?? ''); ?>" readonly>
                            <strong>Telefone:</strong>
                            <input type="text" class="input-text" value="<?php echo htmlspecialchars($usuario['telefone'] ?? ''); ?>" readonly>
                        </p>
                        <p>
                            <strong>CEP:</strong>
                            <input type="text" class="input-text" value="<?php echo htmlspecialchars($usuario['cep'] ?? ''); ?>" readonly>
                            <strong>Endereço:</strong>
                            <input type="text" class="input-text" value="<?php echo htmlspecialchars($usuario['endereco'] ?? ''); ?>" readonly>
                        </p>
    ...
    <footer class="primeiro-rodape">
        <div class="voltar-ao-topo">
            ...
            <a href="#" onclick="subiraoTopo();">Voltar ao topo</a>
            <hr>
        </div>
        <article>
